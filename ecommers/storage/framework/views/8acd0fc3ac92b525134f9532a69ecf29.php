...
<body class="container">
    <div class="row justify-content-center mt-5">
        <div class="col-md-6">
            ...
            <form class="border p-4" method="POST" action="<?php echo e($route); ?>">
                <?php echo csrf_field(); ?>
                <?php if($method === 'PUT'): ?>
...
</html><?php /**PATH E:\laragon\www\rest-api_sakubudget\resources\views/products/form.blade.php ENDPATH**/ ?>